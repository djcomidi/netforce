...
msgB = ''.join( chr(int(msgA[i:i+2],16)) for i in xrange(1,len(msgA),3) )
msgC = ''.join( chr(int(msgB[i:i+2],16)) for i in xrange(1,len(msgB),3) )
print msgC
print "======== BEGIN OF s ============"
